...
use Par3\GolfEnLaNubeBundle\Form\InstitucionType;
...
class InstitucionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GolfEnLaNubeBundle:Institucion')->findAll();
     ...
     * @Method("POST")
     * @Template("GolfEnLaNubeBundle:Institucion:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_institucion_show', array('id' => $entity->getId())));
        }
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GolfEnLaNubeBundle:Institucion')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GolfEnLaNubeBundle:Institucion:edit.html.twig")
     */
