 ...
 */
class User extends \Par3\GolfEnLaNubeBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::addCapitanTemporadaClub($capitanTemporadaClubs);
    }

    public function removeCapitanTemporadaClub(\Par3\GolfEnLaNubeBundle\Entity\TemporadaClub $capitanTemporadaClubs)
    {
        $this->__load();
        return parent::removeCapitanTemporadaClub($capitanTemporadaClubs);
    }

    public function esCapitanDeAlgunTemporadaClub($temporada)
    {
        $this->__load();
        return parent::esCapitanDeAlgunTemporadaClub($temporada);
    }

    public function getCapitanTemporadaClubs()
    {
        $this->__load();
        return parent::getCapitanTemporadaClubs();
    }

    public function getCapitanTemporadaClubsEnTemporada($id_temporada)
    {
        $this->__load();
        return parent::getCapitanTemporadaClubsEnTemporada($id_temporada);
    }

    public function getClubsCapitaneadosEnTemporada($id_temporada)
    {
        $this->__load();
        return parent::getClubsCapitaneadosEnTemporada($id_temporada);
    }

    public function getIdClubsCapitaneadosEnTemporada($id_temporada)
    {
        $this->__load();
        return parent::getIdClubsCapitaneadosEnTemporada($id_temporada);
    }

    public function esCapitanDeTemporadaClub($id_temporada_club)
    {
        $this->__load();
        return parent::esCapitanDeTemporadaClub($id_temporada_club);
    }

    public function esCapitanDeClubEnTemporada($id_club, $id_temporada)
    {
        $this->__load();
        return parent::esCapitanDeClubEnTemporada($id_club, $id_temporada);
    }

    public function autorizadoCrearEquipoEnTorneoFecha(\Par3\GolfEnLaNubeBundle\Entity\Club $club, \Par3\GolfEnLaNubeBundle\Entity\TorneoFecha $torneo_fecha)
    {
        $this->__load();
        return parent::autorizadoCrearEquipoEnTorneoFecha($club, $torneo_fecha);
    }
    ...
    {
        return array('__isInitialized__', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'lastLogin', 'locked', 'expired', 'expiresAt', 'confirmationToken', 'passwordRequestedAt', 'roles', 'credentialsExpired', 'credentialsExpireAt', 'id', 'id_institucion', 'institucion', 'persona', 'groups', 'capitan_temporada_clubs');
    }
