...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev/annotations', true);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3307, 'dbname' => 'golfnube_sistema', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_abe8666cd86897358a7ba284b4b99ede');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_abe8666cd86897358a7ba284b4b99ede');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_abe8666cd86897358a7ba284b4b99ede');
        ...
        $f->setProxyDir('D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev/doctrine/orm/Proxies');
    ...
    /**
     * Gets the 'form.type.entity_hidden' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Par3\GolfEnLaNubeBundle\Form\Type\EntityHiddenType A Par3\GolfEnLaNubeBundle\Form\Type\EntityHiddenType instance.
     */
    ...
    /**
     * Gets the 'golf_en_la_nube.documentos' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Par3\GolfEnLaNubeBundle\Controller\DocumentoController A Par3\GolfEnLaNubeBundle\Controller\DocumentoController instance.
     */
    ...
    /**
     * Gets the 'golf_en_la_nube.menu.main' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * 
     * @throws InactiveScopeException when the 'golf_en_la_nube.menu.main' service is requested while the 'request' scope is not active
     */
    ...
    /**
     * Gets the 'golf_en_la_nube.menu_builder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Par3\GolfEnLaNubeBundle\Menu\MenuBuilder A Par3\GolfEnLaNubeBundle\Menu\MenuBuilder instance.
     */
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/Dropbox/proyectos/webs/circuitopar3/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('D:/Dropbox/proyectos/webs/circuitopar3/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev/sessions');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('D:\\Dropbox\\proyectos\\webs\\circuitopar3\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('D:\\Dropbox\\proyectos\\webs\\circuitopar3\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('D:\\Dropbox\\proyectos\\webs\\circuitopar3\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/Dropbox/proyectos/webs/circuitopar3/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev',
            ...
            'database_port' => 3307,
            'database_name' => 'golfnube_sistema',
            'database_user' => 'root',
            ...
            'debug.container.dump' => 'D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev/profiler',
            ...
            'router.resource' => 'D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/Dropbox/proyectos/webs/circuitopar3/app/cache/dev/doctrine/orm/Proxies',
